...
define("EWPP_PROJECT_NAME", "demo", TRUE); // Project name
...
define("EWPP_PHPMAILER_PATH", "phpmailer51" . EWPP_PATH_DELIMITER . "class.phpmailer.php", TRUE);
define("EWPP_PHPMAILER_LANG_PATH", "phpmailer51" . EWPP_PATH_DELIMITER . "language", TRUE);
...
define("EWPP_LOWERCASE_FILENAME", FALSE, TRUE);
define("EWPP_PROJECT_CHARSET", "utf-8", TRUE); // Project charset
define("EWPP_BODY_TITLE", "PayPal Shop Maker 4 Demo Project", TRUE); // Project title

// Note: Only licensed users are allowed to remove or change the following copyright statement.
define("EWPP_FOOTER_TEXT", "&copy;2010 e.World Technology Ltd. All rights reserved.", TRUE); // Project footer text
...
define("EWPP_BUSINESS", "sales@mycompany.com", TRUE);
...
define("EWPP_DEFAULT_PAGE", "index.php", TRUE);
define("EWPP_IDENTITY_TOKEN", "", TRUE);

// Locale/Currency settings
define("EWPP_CURRENCY_CODE", 'USD', TRUE);
...
define("EWPP_DOWNLOAD_BINARY_WRITE", TRUE, TRUE);
...
define("EWPP_TABLENAME_CATEGORY", EWPP_TABLENAME_PREFIX . "category", TRUE);
...
define("EWPP_CATEGORY_DEFAULT_ORDERBY", "CategoryLevel, CategoryDisplayOrder, CategoryId", TRUE);
...
define("EWPP_INCLUDE_SUBCATEGORY", FALSE, TRUE); // Option to include sub categories
...
define("EWPP_SHOW_SOLD_OUT", TRUE, TRUE); // Show sold out items (if not use item count)
...
define("EWPP_PRODUCT_COUNT_CLASS_NAME", "ewProductCount", TRUE);
...
define("EWPP_SWF_ARGS", "9.0", TRUE); 
define("EWPP_SWF_GET_SIZE_VIEW", TRUE, TRUE); // Use actual swf size in view page
 ...
 */
define("EWPP_MYSQL_CHARSET", "", TRUE);

// Menu
define("EWPP_MENUBAR_ROOTMENU_ID", "ewRootMenu", TRUE);
define("EWPP_MENUBAR_ROOTCAT_ID", "ewRootCat", TRUE);
define("EWPP_MENUBAR_VERTICAL", TRUE, TRUE);
define("EWPP_MENUBAR_CLASSNAME", ((EWPP_MENUBAR_VERTICAL) ? "MenuBarVertical" : "MenuBarHorizontal"), TRUE);
define("EWPP_MENUBAR_SUBMENU_CLASSNAME", "MenuBarItemSubmenu", TRUE);
define("EWPP_MENUBAR_STYLESHEET", ((EWPP_MENUBAR_VERTICAL) ? "SpryMenuBarVertical.css" : "SpryMenuBarHorizontal.css"), TRUE);
...
// URLs
$ewpp_MenuPageUrl = "menupage.php";
$ewpp_CartUrl = "cartlist.php";
$ewpp_CartViewFullUrl = NULL;
$ewpp_CartViewUrl = NULL;

// Debug message
$ewpp_DebugMsg = "";

// Discount code
$EWPP_DISCOUNT_CODE = FALSE; // Init
